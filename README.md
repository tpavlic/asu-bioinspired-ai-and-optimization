...
| [`cross_entropy/cross_entropy_explainer.html`](cross_entropy/cross_entropy_explainer.html) | Interactive explainer stepping from logit scores through softmax and entropy to cross-entropy loss and binary BCE — the information-theoretic foundation behind neural network classification |
...
| [`root_mean_square/rms_explorer.html`](root_mean_square/rms_explorer.html) | Interactive RMS voltage explorer: switch between sine, square, triangle, and sawtooth waveforms to see how RMS voltage depends only on waveform shape and equals the DC voltage that dissipates the same power — building signal-energy intuition that underpins reservoir state analysis |
...
* [Simulating Stochastic Systems — Course Visualizations](https://tpavlic.github.io/asu-simulating-stochastic-systems/) — supplemental visualizations for a separate ASU undergraduate course on simulating systems driven by randomness.
